	...
	<center>
		<table style="margin-left:10%">
         ...
         <tr>
         		<td>Senha:</td>
         		<td><input min="6" type="password" id="senha"  value="<?php echo $linha['senhaUsuario']; ?>" required title="Informe sua senha" 
                name="senhaUsuario" maxlength="8"><br></td>
         </tr>
         <tr>
         	   <td>Confirme a senha:</td>
         	   <td><input type="password" value="<?php echo $linha['senhaUsuario']; ?>" required title="Informe sua senha novamente" 
